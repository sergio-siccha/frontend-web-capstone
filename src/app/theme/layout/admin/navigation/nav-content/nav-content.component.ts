...
export class NavContentComponent implements OnInit, AfterViewInit {
  ...
  @ViewChild('navbarContent', {read: ElementRef, static: false}) navbarContent: ElementRef;
  @ViewChild('navbarWrapper', {read: ElementRef, static: false}) navbarWrapper: ElementRef;
